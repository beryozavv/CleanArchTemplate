...
To update the database use this command from the Web project folder (replace `CleanArch.My` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CleanArch.My.Infrastructure/CleanArch.My.Infrastructure.csproj -s CleanArch.My.Web.csproj
```
