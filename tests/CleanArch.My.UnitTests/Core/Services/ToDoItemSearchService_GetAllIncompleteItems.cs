...
using CleanArch.My.Core.ProjectAggregate;
using CleanArch.My.Core.Services;
using CleanArch.My.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace CleanArch.My.UnitTests.Core.Services
{
